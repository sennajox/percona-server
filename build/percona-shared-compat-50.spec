...
Name:         Percona-SQL-shared-compat
...
%description
This package includes the shared libraries for MySQL 4.0 and 4.1.
...
%files
%defattr(-, root, root)
%{_libdir}/libmysqlclient*12*
%{_libdir}/libmysqlclient*14*
